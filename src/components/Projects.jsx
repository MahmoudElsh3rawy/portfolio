...
const projects = [
  ...
  },
  {
    ...
    description:
      'A code generation tool that automatically generates full Spring Boot entity structure — Model, Controller, Service, Repository, and frontend views.',
    features: [
    ...
    tech: ['React.js', 'Spring Boot', 'Java', 'Docker'],
    github: null,
    live: null,
    private: true,
    image: entityImg,
  ...
  },
  {
    ...
    description:
      'A full-featured admin panel for managing users, services, and platform data with complete CRUD operations.',
    features: [
  ...
  },
  {
    ...
    description:
      'A responsive car services website with service listings, company info, and contact options. Built with PHP and Laravel.',
    features: [
      'Service listings',
      'Clean navigation',
      'Contact system',
  ...
  },
  {
    ...
    description:
      'A full-stack articles management system with CRUD operations, built with Angular and Node.js.',
    features: [
